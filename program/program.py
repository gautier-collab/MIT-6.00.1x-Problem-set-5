...
WORDLIST_FILENAME = os.path.join(currentDir, "words.txt")
...
def decrypt_story():
    theStory = get_story_string()
    x = CiphertextMessage(theStory)
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for elem in string.ascii_lowercase:
            ...
            if NewLetter > 25:
                NewLetter -= 26
            value = string.ascii_lowercase[NewLetter]
            self.dic[key] = value
            k += 1
        k = 0
        for elem in string.ascii_uppercase:
            ...
            if NewLetter > 25:
                NewLetter -= 26
            value = string.ascii_uppercase[NewLetter]
            self.dic[key] = value
            k += 1
...
class PlaintextMessage(Message):
    ...
    def get_encrypting_dict(self):
        ...
        '''
        import copy
        return copy.copy(self.encrypting_dict)
